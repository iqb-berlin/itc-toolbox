...
COMMIT;"
                ...
                For Each b As Booklet In p.booklets
                    ...
                    cmd.CommandText = "select id, lastTs, firstTs from [booklet] where personId = @personId AND name = @bookletName LIMIT 1"
...
DELETE FROM [booklet] WHERE id=" + bookletDbId.ToString + ";"
                        ...
                        cmd.CommandText = "
BEGIN TRANSACTION;
INSERT INTO [booklet] ([personId],[name],[firstTs],[lastTs]) VALUES (" + personDbId.ToString + ", '" +
b.id + "'," + b.firstTS.ToString + "," + b.lastTS.ToString + ");
SELECT last_insert_rowid();
COMMIT;"
